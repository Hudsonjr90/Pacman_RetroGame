...
(function (e, t) {
        ...
        (o = at.selectors =
          {
            ...
            pseudos: {
              ...
              last: ht(function (_e, t) {
                return [t - 1];
              }),
              eq: ht(function (_e, t, n) {
                return [0 > n ? n + t : n];
              }),
  ...
  function F(e) {
    var t = (O[e] = {});
    return (
      x.each(e.match(T) || [], function (_e, n) {
        t[n] = !0;
      }),
      t
    );
    ...
    var n,
      ...
      p = {
        ...
        remove: function () {
          return (
            l &&
              x.each(arguments, function (_e, t) {
                var r;
  ...
  x.fn.extend({
    ...
    x.each(x.expr.match.bool.source.match(/\w+/g), function (_e, n) {
    ...
    Q ||
      ...
      x.each(["width", "height"], function (_e, n) {
        x.attrHooks[n] = {
          set: function (e, r) {
  ...
  x.each(["height", "width"], function (_e, n) {
    x.cssHooks[n] = {
      get: function (e, r, i) {
        return r
  ...
  (x.fn.load = function (e, n, r) {
    ...
    x.each(["get", "post"], function (n) {
      x[n] = function (url, data, successCallback, dataType) {
        return x.ajax({
          url: url,
          type: n,
          data: data,
  ...
  (x.Tween = rr),
    ...
    x.each(["toggle", "show", "hide"], function (_e, t) {
      var n = x.fn[t];
